...
CREATE TABLE "items" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255), "price" float, "description" varchar(255), "category_id" integer, "lot_id" integer, "created_at" datetime, "updated_at" datetime);
CREATE TABLE "lots" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255), "price" float, "description" varchar(255), "end_time" time, "bet_step" float, "time_step" time, "item_id" integer, "created_at" datetime, "updated_at" datetime);
